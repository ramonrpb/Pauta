...
@ViewScoped
@ManagedBean(name="alunoAvaliacaoMB")
public class AlunoAvaliacaoManagedBean implements Serializable {
...
//			}
	...
	public void handleChange(ValueChangeEvent event){  
		    ...
		    event.getComponent().getAttributes().get("nota");
	}
	...
	public List<AlunoAvaliacao> getListaAlunoAvaliacao() {
		return listaAlunoAvaliacao;
	}

	public void setListaAlunoAvaliacao(List<AlunoAvaliacao> listaAlunoAvaliacao) {
		this.listaAlunoAvaliacao = listaAlunoAvaliacao;
	}
	...
	public void setListaAlunoAvaliacaoMap(Map<Aluno, Map<Avaliacao, AlunoAvaliacao>> listaAlunoAvaliacaoMap) {
